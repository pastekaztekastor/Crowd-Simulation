...
![Alt text](content/Brainstorming/tableau1.jpg)
![Alt text](content/Brainstorming/tableau2.jpg)
  ...
  - simulation
    ...
    - utilisation du kernel/model
      - il retourne le déplacement de l'individue
        ![Alt text](<content/Kernel%20return%20patern/kernelReturnPatern.png>)
